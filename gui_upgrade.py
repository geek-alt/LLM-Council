...
.panel-left  { min-height: calc(100vh - 185px); }
.panel-right { min-height: calc(100vh - 185px); }
...
.scroll-pane textarea { min-height: 58vh !important; }
...
@media (max-width: 1100px) {
    ...
    .scroll-pane { max-height: 50vh; }
    .scroll-pane textarea { min-height: 40vh !important; }
